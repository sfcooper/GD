...
class GinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gin" do
    assert_difference('Gin.count') do
      post gins_url, params: { gin: { description: @gin.description, distillary_id: @gin.distillary_id, name: @gin.name, slug: @gin.slug, snippet: @gin.snippet } }
    end
  ...
  test "should update gin" do
    patch gin_url(@gin), params: { gin: { description: @gin.description, distillary_id: @gin.distillary_id, name: @gin.name, slug: @gin.slug, snippet: @gin.snippet } }
