...
class BotanicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create botanical" do
    assert_difference('Botanical.count') do
      post botanicals_url, params: { botanical: { description: @botanical.description, name: @botanical.name, slug: @botanical.slug } }
    end
  ...
  test "should update botanical" do
    patch botanical_url(@botanical), params: { botanical: { description: @botanical.description, name: @botanical.name, slug: @botanical.slug } }
